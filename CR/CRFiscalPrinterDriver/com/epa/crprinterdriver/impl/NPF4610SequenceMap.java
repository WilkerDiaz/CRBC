 ...
 * Eliminación de bug en redondeo de cantidades
 *
 ...
 * </p>
 * <p>
 * <a href="NPF4610SequenceMap.java.html"><i>View Source</i></a>
 * </p>
 * 
...
* Sólo se comento variable sin uso
* Fecha: agosto 2011
*/
public class NPF4610SequenceMap implements CRFPSequenceMap {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger
			.getLogger(NPF4610SequenceMap.class);
	...
	private String convertirCadena(String mensaje) {
		...
		String stringCaracteresAModificar="áéíóúÁÉÍÓÚñÑ°º`´üÜàèìòùÀÈÌÒÙÊÂÎÔÛâêîôû";
	 ...
	 */
	public NPF4610SequenceMap(CRFPStatus status) {
		super();
		statusDriver = status;
	}
	...
	int getCommandType(char seqCommand) {
		...
		case 'U':
			...
			break;
		case '{':
			result = CRFiscalPrinterOperations.CMD_ABRIR_GAVETA;
			break;
	}
