 ...
 * 
 */
public class CRFPEngine_old implements DocumentListener, SerialSignalListener, Runnable, ResponseListener, StatusChangeListener {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(CRFPEngine.class);
	 ...
	 * 
	 */
	public CRFPEngine_old(CRFPSubsystem parent,
...
//						reenvioComando :
	...
	*/
	...
	public synchronized Object getSimpleResponse(CRFPCommand cmd) throws PrinterNotConnectedException {
		...
		Object result = null;
		//TODO: Validar que el comando devuelva informacion simple
		synchronized (sender) {
			solicitudInfo = cmd;
			infoRetornada = false;
			sender.notify();
