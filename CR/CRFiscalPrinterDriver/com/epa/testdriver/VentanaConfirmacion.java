 ...
 */
public class VentanaConfirmacion extends JDialog implements KeyListener,
        MouseListener {
    /**
	 * 
	 */
	private static final long serialVersionUID = -3943469464523704316L;
    ...
    public VentanaConfirmacion(String xMensaje, String txtBtn0, String txtBtn1) {
        ...
        altoTexto = jTextArea.getUI().getPreferredSize(this.jTextArea)
                .getHeight();
        anchoTexto = jTextArea.getUI().getPreferredSize(this.jTextArea)
                .getWidth();
    ...
    public VentanaConfirmacion(String xMensaje, JFrame parent, String txtBtn0,
            String txtBtn1) {
        super(parent);
        this.getJTextArea().setText(xMensaje);
        altoTexto = jTextArea.getUI().getPreferredSize(this.jTextArea)
    ...
    private javax.swing.JPanel getJPanel3() {
        ...
        if (jPanel3 == null) {
            ...
            jPanel3.setPreferredSize(new java.awt.Dimension(
                    this.getWidth() - 20, this.getHeight() - 80));
    ...
    private javax.swing.JPanel getJPanel4() {
        ...
        if (jPanel4 == null) {
            ...
            jPanel4.setPreferredSize(new java.awt.Dimension((int) getJPanel3()
                    .getPreferredSize().getWidth() - 2, 40));
        ...
        if (jLabel1 == null) {
            ...
            /*jLabel1
                    .setIcon(new javax.swing.ImageIcon(
                            getClass()
                                    .getResource(
                                            "/com/becoblohm/cr/gui/resources/icons/ix32x32/help2.png")));*/
    ...
    protected javax.swing.JPanel getJPanel5() {
        ...
        if (jPanel5 == null) {
            ...
            java.awt.BorderLayout borderLayout21 = new java.awt.BorderLayout();
            borderLayout21.setHgap(5);
            borderLayout21.setVgap(10);
            jPanel5.setLayout(borderLayout21);
            jPanel5.add(getJTextArea(), BorderLayout.NORTH);
            jPanel5.setPreferredSize(new java.awt.Dimension((int) jPanel3
                    .getPreferredSize().getWidth() - 5, (int) altoTexto + 10));
    ...
    private javax.swing.JTextArea getJTextArea() {
        ...
        if (jTextArea == null) {
            ...
            jTextArea.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
                    0, 0, 0));
    ...
    public char getOpcionPorDefecto() {
        return this.opcionDefault;
    }
