...
public abstract class Transaccion implements Serializable {
	...
	protected Vector detallesTransaccion;
	...
	public Transaccion(int tda, Date fecha, int cajaInicia, int regCajaInicia, Time horaInicia, String cajero,
		...
		this.detallesTransaccion = new Vector();
	...
	protected DetalleTransaccion obtenerLineaProd(String codProd) throws ProductoExcepcion {
		...
		for (int i=0; i<detallesTransaccion.size(); i++) {
			Producto prod = ((DetalleTransaccion) detallesTransaccion.elementAt(i)).getProducto();
				if (prod.getCodProducto() == codProd) {
					detalleTrans = (DetalleTransaccion) detallesTransaccion.elementAt(i);
					 break;
				}
		}
	 ...
	 */
	public Vector verificarPromociones(Producto prod) {
		if (logger.isDebugEnabled()) {
	 ...
	 */
	public Vector getDetallesTransaccion() {
		if (logger.isDebugEnabled()) {
	...
	*/
	...
	public void setDetallesTransaccion(Vector detallesTransaccion) {
