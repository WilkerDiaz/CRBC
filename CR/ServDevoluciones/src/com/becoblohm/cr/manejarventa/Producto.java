...
public class Producto implements Serializable {
	 ...
	 */
	public Producto(String codProd, String descCorta, String descLarga, int codUnidVta, String descUnidVta, String abrevUnidVta, boolean indFracc, String refProv, String marca, String mod, String codDep, String linSecc, double costoLista, double precio, float cantidadEmpaque, double desctoEmpaque, boolean indicaDctoEmp, double desctoEmpleado, char edo, Date fechaAct, Time horaAct, Impuesto imp, Vector proms, String tipoEnt) {
		this.codProducto = codProd;
