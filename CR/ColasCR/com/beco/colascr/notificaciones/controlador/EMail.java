 ...
 *
 *  @author Jorg Janke
 *  @version  $Id: EMail.java 8244 2009-12-04 23:25:29Z freyes $
 */
/*
...
public final class EMail implements Serializable
{
    ...
    /**
     * Establece la ip del host smtp y el puerto
     * @param smtpHost
     * @param port
     */
    /*public void setSmtpHost(String host,String port){
    	smtpHost = host;
    	puerto = port;
    }*/
		...
		String subject, String message, String htmlMessage)
	{
		...
		else if (htmlMessage!=null && htmlMessage.length() > 0)
			setMessageHTML(htmlMessage);
	...
	public static void main (String[] args)
	{
		...
		/*try{
			EMail email = new EMail("74.125.93.109", 465, true, 
				"jgraterol@beco.com.ve", "jgraterol", "grateroljesus@gmail.com", "grateroljesus", "Prueba", "Probando");
			email.createAuthenticator("jgraterol@beco.com.ve", "");
			email.send();
		} catch(Exception e){
			e.printStackTrace();
		}*/
