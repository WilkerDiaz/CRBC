...
public class Usuario implements net.sf.hibernate.Lifecycle,Serializable {
    ...
    /** identifier field */
    private com.beco.colascr.transferencias.sincronizador.hibernate.UsuarioPK comp_id;
    ...
    /** full constructor */
    public Usuario(com.beco.colascr.transferencias.sincronizador.hibernate.UsuarioPK comp_id, String codigobarra, String codperfil, String clave, String nivelauditoria, String nombre, String puedecambiarclave, String indicacambiarclave, Date fechacreacion, Date ultimocambioclave, short tiempovigenciaclave, String regvigente, Date actualizacion) {
    ...
    /** minimal constructor */
    public Usuario(com.beco.colascr.transferencias.sincronizador.hibernate.UsuarioPK comp_id, String codigobarra, String codperfil, String clave, String nivelauditoria, String puedecambiarclave, String indicacambiarclave, Date fechacreacion, short tiempovigenciaclave, String regvigente) {
        this.comp_id = comp_id;
        this.codigobarra = codigobarra;
        this.codperfil = codperfil;
        this.clave = clave;
    ...
    public com.beco.colascr.transferencias.sincronizador.hibernate.UsuarioPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(com.beco.colascr.transferencias.sincronizador.hibernate.UsuarioPK comp_id) {
        this.comp_id = comp_id;
    }
