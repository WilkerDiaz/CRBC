...
#
# Dumping Table Structure for afiliado1

#
CREATE TABLE `afiliado1` (
  `codafiliado` varchar(12) binary NOT NULL default '',
  `tipoafiliado` char(1) NOT NULL default '',
  `nombre` varchar(100) NOT NULL default '',
  `apellido` varchar(100) default NULL,
  ...
  KEY `idx_ficha` (`numficha`),
  KEY `idx_nombre` (`nombre`)
) TYPE=InnoDB COMMENT='Maestro de afiliados temporales';
#
# Dumping Table Structure for afiliadotemp

#
CREATE TABLE `afiliadotemp` (
  `codafiliado` varchar(12) binary NOT NULL default '',
  `tipoafiliado` char(1) NOT NULL default '',
  `nombre` varchar(100) NOT NULL default '',
  `apellido` varchar(100) default NULL,
  ...
  `estadocivil` char(1) NOT NULL default '',
  `fechanacimiento` date default '0000-00-00',
  PRIMARY KEY  (`codafiliado`,`registrado`)
) TYPE=InnoDB COMMENT='Tabla Temporal de Afiliados Usada para Tranferencia FTP';
#
...
#
# Dumping Table Structure for condvtatiptra

#
CREATE TABLE `condvtatiptra` (
  `condventa` char(2) NOT NULL default '',
  `tiptra` char(2) NOT NULL default ''
) TYPE=InnoDB COMMENT='Relación entre condición vta de CR y tipTra en AS';
#
...
#
# Dumping Table Structure for detallelistaregalos

#
CREATE TABLE `detallelistaregalos` (
  `codlista` int(11) NOT NULL default '0',
  ...
  `cantcomprado` decimal(8,2) NOT NULL default '0.00',
  `montoabonos` decimal(13,2) NOT NULL default '0.00',
  `actualizacion` timestamp(14) NOT NULL,
  PRIMARY KEY  (`codlista`,`codproducto`),
  KEY `idx_lista` (`codlista`),
  KEY `idx_promocion` (`codpromocion`),
  KEY `idx_producto` (`codproducto`),
  KEY `idx_tipocaptura` (`codtipocaptura`),
  CONSTRAINT `detallelistaregalos_ibfk_1` FOREIGN KEY (`codtipocaptura`) REFERENCES `tipocaptura` (`codtipocaptura`) ON UPDATE CASCADE,
  CONSTRAINT `detallelistaregalos_ibfk_2` FOREIGN KEY (`codlista`) REFERENCES `listaregalos` (`codlista`) ON DELETE CASCADE,
  CONSTRAINT `detallelistaregalos_ibfk_3` FOREIGN KEY (`codproducto`) REFERENCES `producto` (`codproducto`) ON UPDATE CASCADE,
  CONSTRAINT `detallelistaregalos_ibfk_4` FOREIGN KEY (`codpromocion`) REFERENCES `promocion` (`codpromocion`) ON UPDATE CASCADE
) TYPE=InnoDB COMMENT='Tabla con detalles de listas de regalos';
#
# Dumping Table Structure for detalleoperacionlistaregalos

#
CREATE TABLE `detalleoperacionlistaregalos` (
  `numoperacion` int(11) NOT NULL default '0',
  `codlista` int(11) NOT NULL default '0',
  `codformadepago` varchar(10) NOT NULL default '',
  `monto` decimal(13,2) NOT NULL default '0.00',
  `montovuelto` decimal(13,2) NOT NULL default '0.00',
  `correlativo` smallint(6) NOT NULL default '0',
  `actualizacion` timestamp(14) NOT NULL,
  PRIMARY KEY  (`numoperacion`,`codlista`,`codformadepago`,`correlativo`),
  KEY `IDX_detalleoperacionlistaregalos_2` (`codformadepago`),
  KEY `IDX_detalleoperacionlistaregalos_3` (`numoperacion`,`codlista`),
  CONSTRAINT `FK_detalleoperacionlistaregalos_1` FOREIGN KEY (`codformadepago`) REFERENCES `formadepago` (`codformadepago`) ON UPDATE CASCADE,
  CONSTRAINT `FK_detalleoperacionlistaregalos_2` FOREIGN KEY (`numoperacion`, `codlista`) REFERENCES `operacionlistaregalos` (`numoperacion`, `codlista`) ON UPDATE CASCADE
) TYPE=InnoDB;
#
...
#
# Dumping Table Structure for detallepromociontransf

#
CREATE TABLE `detallepromociontransf` (
  `codpromocion` int(11) NOT NULL default '0',
  `numdetalle` int(11) NOT NULL default '0',
  `numcupon` int(11) default NULL,
  `coddepartamento` char(2) default NULL,
...
CREATE TABLE `detalleserviciocondicion` (
  ...
  CONSTRAINT `FK_detalleserviciocondicion_2` FOREIGN KEY (`numtienda`, `codtiposervicio`, `numservicio`, `fecha`, `codproducto`, `condicionventa`, `correlativoitem`) REFERENCES `detalleservicio` (`numtienda`, `codtiposervicio`, `numservicio`, `fecha`, `codproducto`, `codcondicionventa`, `correlativoitem`) ON DELETE CASCADE ON UPDATE CASCADE
) TYPE=InnoDB;
#
# Dumping Table Structure for detalleserviciotemp

#
CREATE TABLE `detalleserviciotemp` (
  `numtienda` smallint(6) NOT NULL default '0',
  `codtiposervicio` char(2) NOT NULL default '',
  `numservicio` int(11) NOT NULL default '0',
  `fecha` date NOT NULL default '0000-00-00',
  ...
  `estadoregistro` char(1) NOT NULL default 'V',
  `regactualizado` char(1) NOT NULL default 'N',
  KEY `IDX_detalleserviciotemp` (`numtienda`,`codtiposervicio`,`numservicio`,`fecha`,`codproducto`,`codcondicionventa`,`correlativoitem`)
) TYPE=InnoDB COMMENT='Tabla con detalles de los servicios vigentes';
#
...
#
# Dumping Table Structure for devolucionespera

#
CREATE TABLE `devolucionespera` (
  `numtienda` smallint(3) NOT NULL default '0',
  `fecha` date NOT NULL default '0000-00-00',
  `caja` smallint(3) NOT NULL default '0',
  `numtransaccion` int(11) NOT NULL default '0',
  `tipotransaccion` char(1) NOT NULL default '',
  `objeto` blob,
  PRIMARY KEY  (`numtienda`,`fecha`,`caja`,`numtransaccion`,`tipotransaccion`)
) TYPE=InnoDB COMMENT='Tabla para almacenar devoluciones en espera';
#
...
#
# Dumping Table Structure for listaregalos

#
CREATE TABLE `listaregalos` (
  `codlista` int(11) NOT NULL default '0',
  `tipolista` char(1) NOT NULL default '',
  `codtitular` varchar(12) binary NOT NULL default '',
  `fechaevento` date NOT NULL default '0000-00-00',
  `tipoevento` varchar(50) NOT NULL default '',
  `titularsec` varchar(50) default NULL,
  `fechaapertura` date NOT NULL default '0000-00-00',
  `numtiendaapertura` smallint(6) NOT NULL default '0',
  `numcajaapertura` smallint(3) NOT NULL default '0',
  `codcajeroapertura` varchar(12) NOT NULL default '',
  `fechacierre` date default NULL,
  `numtiendacierre` smallint(6) default NULL,
  `numcajacierre` smallint(3) default NULL,
  `codcajerocierre` varchar(12) default NULL,
  `montobase` decimal(13,2) NOT NULL default '0.00',
  `montoimpuesto` decimal(16,2) NOT NULL default '0.00',
  `cantproductos` smallint(6) NOT NULL default '0',
  `montoabonos` decimal(13,2) default '0.00',
  `notificaciones` char(1) NOT NULL default '',
  `permitirventa` char(1) NOT NULL default '',
  `estado` char(1) NOT NULL default '',
  `actualizacion` timestamp(14) NOT NULL,
  PRIMARY KEY  (`codlista`),
  KEY `idx_cajaapertura` (`numtiendaapertura`,`numcajaapertura`),
  KEY `idx_cajacierre` (`numtiendacierre`,`numcajacierre`),
  KEY `idx_codtitular` (`codtitular`),
  CONSTRAINT `fk_cajaapertura` FOREIGN KEY (`numtiendaapertura`, `numcajaapertura`) REFERENCES `caja` (`numtienda`, `numcaja`) ON UPDATE CASCADE,
  CONSTRAINT `fk_codtitular` FOREIGN KEY (`codtitular`) REFERENCES `afiliado` (`codafiliado`) ON UPDATE CASCADE
) TYPE=InnoDB COMMENT='Detalles de las Listas de Regalos';
#
# Dumping Table Structure for listaregalosespera

#
CREATE TABLE `listaregalosespera` (
  `numtienda` smallint(3) NOT NULL default '0',
  `fecha` date NOT NULL default '0000-00-00',
  `caja` smallint(3) NOT NULL default '0',
  `codafiliado` varchar(12) binary NOT NULL default '0',
  `tipotransaccion` char(1) NOT NULL default '',
...
#
# Dumping Table Structure for operacionlistaregalos

#
CREATE TABLE `operacionlistaregalos` (
  `numoperacion` int(11) NOT NULL default '0',
  `numtransaccion` int(11) default NULL,
  `codcliente` varchar(12) default NULL,
  `nomcliente` varchar(50) default NULL,
  `codlista` int(11) NOT NULL default '0',
  `fecha` date NOT NULL default '0000-00-00',
  `tipooperacion` char(1) NOT NULL default '',
  `codproducto` varchar(12) NOT NULL default '',
  `montobase` decimal(13,2) NOT NULL default '0.00',
  `montoimpuesto` decimal(16,5) NOT NULL default '0.00000',
  `cantidad` decimal(8,2) NOT NULL default '0.00',
  ...
  `dedicatoria` varchar(200) default NULL,
  `actualizacion` timestamp(14) NOT NULL,
  `correlativoitem` int(11) NOT NULL default '1',
  PRIMARY KEY  (`numoperacion`,`codlista`,`codproducto`,`tipooperacion`,`correlativoitem`),
  KEY `idx_cajero` (`codcajero`),
  KEY `idx_caja` (`numtienda`,`numcaja`),
  KEY `idx_codlista` (`codlista`),
  CONSTRAINT `fk_cajero` FOREIGN KEY (`codcajero`) REFERENCES `afiliado` (`numficha`) ON UPDATE CASCADE,
  CONSTRAINT `fk_codlista` FOREIGN KEY (`codlista`) REFERENCES `listaregalos` (`codlista`) ON DELETE CASCADE ON UPDATE CASCADE
) TYPE=InnoDB;
#
...
#
# Dumping Table Structure for serviciotemp

#
CREATE TABLE `serviciotemp` (
  `numtienda` smallint(6) NOT NULL default '0',
  `codtiposervicio` char(2) NOT NULL default '',
  `numservicio` int(11) NOT NULL default '0',
  `fecha` date NOT NULL default '0000-00-00',
...
CREATE TABLE `transaccionafiliadocrm` (
  ...
  CONSTRAINT `FK_transaccionafiliadocrm_2` FOREIGN KEY (`codafiliado`) REFERENCES `afiliado` (`codafiliado`)
) TYPE=InnoDB COMMENT='Está tabla tendrá los afiliados de CRM';
#
# Dumping Table Structure for transaccionpremcontrol

#
CREATE TABLE `transaccionpremcontrol` (
  `NROTRANSACCIONES` int(11) NOT NULL default '0',
  `NROTRANSACCIONESXDIA` int(11) NOT NULL default '0',
  `MAXPREMBS` double(13,5) NOT NULL default '0.00000',
  `MAXIPREMBSXDIA` double(13,5) NOT NULL default '0.00000',
  `codpromocion` int(11) NOT NULL default '0',
  `regactualizado` char(1) NOT NULL default 'N',
  PRIMARY KEY  (`codpromocion`),
  UNIQUE KEY `IDX_transaccionpremcontrol_2` (`codpromocion`),
  CONSTRAINT `FK_transaccionpremcontrol_1` FOREIGN KEY (`codpromocion`) REFERENCES `detallepromocionext` (`codPromocion`) ON DELETE CASCADE ON UPDATE CASCADE
) TYPE=InnoDB;
#
