...
* Sólo se agregaron algunos 'suppressWarnings' para las funciones declaradas
* 'private' y no usadas localmente
* Fecha: agosto 2011
*/
public class ComprobanteAnulacionApartado extends Reporte {
	...
	*/
	...
	private static void crearTotales(Apartado apartado, double totalAbonosActivos) {
		...
		Sesion.crPrinterOperations.enviarString(alinearDerecha(justificar("SUB MONTO          : ",precio.format(apartado.getMontoBase()),35),columnasImpresora)+"\n");
		...
		Sesion.crPrinterOperations.enviarString(alinearDerecha(justificar("MONTO APARTADO     : ",precio.format(apartado.consultarMontoServ()),35),columnasImpresora)+"\n");
		Sesion.crPrinterOperations.enviarString(crearLineaDeDivision(columnasImpresora)+"\n");
		...
		Sesion.crPrinterOperations.enviarString(alinearDerecha("--------------------",columnasImpresora)+"\n");
		Sesion.crPrinterOperations.enviarString(alinearDerecha(justificar("MONTO ANULACIÓN    : ",precio.format(totalAbonosActivos -  cargoServicio),35),columnasImpresora)+"\n");
		Sesion.crPrinterOperations.enviarString(crearLineaDeDivision(columnasImpresora)+"\n");
	...
	*/
	...
	private static void crearTotalesFiscal(Apartado apartado, double totalAbonosActivos) {
		...
		Sesion.crFiscalPrinterOperations.enviarLineaNoFiscal(alinearDerecha(justificar("SUB MONTO          : ",precio.format(apartado.getMontoBase()),35),columnasImpresoraFiscal), 0);
		...
		Sesion.crFiscalPrinterOperations.enviarLineaNoFiscal(alinearDerecha(justificar("MONTO APARTADO     : ",precio.format(apartado.consultarMontoServ()),35),columnasImpresoraFiscal), 0);
		Sesion.crFiscalPrinterOperations.enviarLineaNoFiscal(crearLineaDeDivision(columnasImpresoraFiscal), 0);
		...
		Sesion.crFiscalPrinterOperations.enviarLineaNoFiscal(alinearDerecha("--------------------",columnasImpresoraFiscal), 0);
		Sesion.crFiscalPrinterOperations.enviarLineaNoFiscal(alinearDerecha(justificar("MONTO ANULACIÓN    : ",precio.format(totalAbonosActivos -  cargoServicio),35),columnasImpresoraFiscal), 0);
		Sesion.crFiscalPrinterOperations.enviarLineaNoFiscal(crearLineaDeDivision(columnasImpresoraFiscal), 0);
