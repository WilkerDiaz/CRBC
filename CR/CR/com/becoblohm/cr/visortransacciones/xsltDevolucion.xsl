...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
		<HTML>
			<BODY>
				<xsl:apply-templates select="devolucion"/>
			</BODY>
		</HTML>    
    </xsl:template>
    
   <xsl:template match="devolucion">
		<TABLE border="0">
		<TBODY>
			<TR>
				...
				<FONT size="5" face="Arial"><B> </B></FONT><FONT size="6"
					face="Arial"><B>D E V O L U C I O N</B></FONT>
				<HR noshade=""/>
				</TD>
			</TR>			
			<TR>
				...
				<TD width="425"><FONT size="3" face="Arial"></FONT>
					...
					<TBODY>
						...
						<TR>
							...
							<FONT size="5" face="Arial"><B>COMPROBANTE FISCAL</B></FONT><HR/></TD>
						</TR>
					</TBODY>
					</TABLE>
			</TD>
			...
			<TR>
					...
					<TR>
						<TD width="425" height="43"><p align="center"><FONT size="6" face="Arial"><B>D E V O L U C I O N</B></FONT></p><BR/>
							
						</TD>
					</TR>
					<TR>
						<TD width="425" height="44"><FONT size="3" face="Arial"><B>Notas: </B></FONT>
						<UL>
							<LI><FONT size="3" face="Arial">Esta devolución está relacionada con la transacción #<xsl:value-of select="format-number(./ventaOriginal/numTransaccion, '0')"/>, de fecha <xsl:value-of select="./ventaOriginal/fechaTrans"/>, de caja #<xsl:value-of select="format-number(./ventaOriginal/numCajaFinaliza, '0')"/> por tienda T#<xsl:value-of select="format-number(./ventaOriginal/codTienda, '000')"/></FONT></LI>
						</UL>
						</TD>
					</TR>
				</TBODY>
