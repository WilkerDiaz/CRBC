 ...
 * Programa   : UpdFuncionPerfil.java
...
public class UpdFuncionPerfil {
	...
	protected void initializer() {
		...
		try {
			...
			modify.setCommand(
				"UPDATE funcionperfil SET habilitado = :habilitado, autorizado = :autorizado, actualizacion = CURRENT_TIMESTAMP WHERE funcionperfil.codmodulo = :codModulo AND funcionperfil.codfuncion = :codFuncion AND funcionperfil.codperfil = :codPerfil");
