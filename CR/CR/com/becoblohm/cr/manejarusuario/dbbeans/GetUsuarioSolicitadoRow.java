 ...
 * Programa   : GetUsuarioSolicitadoRow.java
 ...
 * de la consulta a la tabla Usuario de la Caja Registradora; contenida 
 * en DBSelect.
 */

public class GetUsuarioSolicitadoRow {
	 ...
	 */
	public GetUsuarioSolicitadoRow(DBSelect aRef, int aRowNumber) {
		select = aRef;
