 ...
 * Programa   : AddFuncionMetodo.java
...
public class AddFuncionMetodo {
	...
	protected void initializer() {
		...
		try {
			...
			modify.setCommand(
				"INSERT INTO funcionmetodos ( codmodulo, codfuncion, codmetodo ) VALUES ( :codModulo, :codFuncion, :codMetodo )");
