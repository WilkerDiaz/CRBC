...
public class CondicionVenta implements Serializable {
	 ...
	 * @param codPromocion
	 */
	public CondicionVenta(String condicion, int codPromocion, double porcentajeDescuento, String nombrePromocion, int prioridad) {
		this.condicion = condicion;
		this.codPromocion = codPromocion;
		this.nombrePromocion = nombrePromocion;
		this.porcentajeDescuento = porcentajeDescuento;
		this.prioridadPromocion = prioridad;
	}
