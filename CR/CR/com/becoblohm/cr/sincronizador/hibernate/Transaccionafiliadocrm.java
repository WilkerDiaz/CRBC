...
public class Transaccionafiliadocrm implements Serializable, EntidadMarcable {
	...
	private com.becoblohm.cr.sincronizador.hibernate.TransaccionafiliadocrmPK comp_id;
	...
	{}
	//constructor full
	public Transaccionafiliadocrm(com.becoblohm.cr.sincronizador.hibernate.TransaccionafiliadocrmPK comp_id, String contribuyente, String regactualizado, Time horainiciacrm, Time horafinalizacrm)
	{
	...
	public com.becoblohm.cr.sincronizador.hibernate.TransaccionafiliadocrmPK getComp_id() {
		return comp_id;
	}

	public void setComp_id(
			com.becoblohm.cr.sincronizador.hibernate.TransaccionafiliadocrmPK comp_id) {
		this.comp_id = comp_id;
	}
