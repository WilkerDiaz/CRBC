...
public class GetClienteJuridicoRow {
	 ...
	 */
	public GetClienteJuridicoRow(DBSelect aRef, int aRowNumber) {
		select = aRef;
		rowNumber = aRowNumber;
	}

	/**
	 * Devuelve el valor de la columna CABJURIDIC_NUMNIT en la fila representada por este objeto.
	 */
	public Object getCABJURIDIC_NUMNIT() throws SQLException {
