...
public class GetCajaRow {
	 ...
	 */
	public GetCajaRow(DBSelect aRef, int aRowNumber) {
		select = aRef;
		rowNumber = aRowNumber;
	}

	/**
	 * Devuelve el valor de la columna Caja_numtienda en la fila representada por este objeto.
	 */
	public Object getCaja_numtienda() throws SQLException {
		return select.getCacheValueAt(rowNumber, 1);
	}

	/**
	 * Devuelve el valor de la columna Caja_numcaja en la fila representada por este objeto.
	 */
	public Object getCaja_numcaja() throws SQLException {
