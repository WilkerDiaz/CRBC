 ...
 * Generated:  17/10/2003 11:30:47 AM
 */

public class GetRegionRow {
	 ...
	 */
	public GetRegionRow(DBSelect aRef, int aRowNumber) {
		select = aRef;
		rowNumber = aRowNumber;
	}

	/**
	 * Devuelve el valor de la columna Region_codregion en la fila representada por este objeto.
	 */
	public Object getRegion_codregion() throws SQLException {
		return select.getCacheValueAt(rowNumber, 1);
	}

	/**
	 * Devuelve el valor de la columna Region_descripcion en la fila representada por este objeto.
	 */
	public Object getRegion_descripcion() throws SQLException {
