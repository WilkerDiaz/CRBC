 ...
 * Generated:  08/10/2003 04:53:23 PM
 */
...
public class AddDepartamento {
	...
	protected void initializer() {
		...
		try {
			...
			modify.setCommand(
				"INSERT INTO departamento ( coddepartamento, nombre ) VALUES ( :codDepartamento, :nombre )");
	 ...
	 */
	public void execute(String codDepartamento, String nombre)
		throws SQLException {
		try {
