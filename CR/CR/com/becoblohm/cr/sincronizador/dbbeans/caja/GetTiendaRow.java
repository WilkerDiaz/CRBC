 ...
 * Generated:  17/10/2003 08:42:09 AM
 */

public class GetTiendaRow {
	 ...
	 */
	public GetTiendaRow(DBSelect aRef, int aRowNumber) {
		select = aRef;
		rowNumber = aRowNumber;
	}

	/**
	 * Devuelve el valor de la columna Tienda_numtienda en la fila representada por este objeto.
	 */
	public Object getTienda_numtienda() throws SQLException {
	...
	/**
	 * Devuelve el valor de la columna Tienda_razonsocial en la fila representada por este objeto.
	 */
	public Object getTienda_razonsocial() throws SQLException {
