 ...
 * Programa   : DefaultManejadorReportes.java
 ...
 */
public class DefaultManejadorReportes implements ManejadorReportes {
	/**
	...
	* Fecha: agosto 2011
	*/
	public void imprimirConsolidadoBR(int nroComprobanteCP, Vector<Vector<Object>> fPagos, Usuario usuario) {
		if (logger.isDebugEnabled())
