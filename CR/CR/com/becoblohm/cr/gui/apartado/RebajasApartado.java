 ...
 */
public class RebajasApartado extends JDialog implements ComponentListener, KeyListener, MouseListener, EventListener, DocumentListener {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger
			.getLogger(RebajasApartado.class);
	...
	private ModeloTablaApartado modeloTablaRebaja = new ModeloTablaApartado(1);
	...
	/**
	 * Constructor para RebajasApartado.java
	 *
	 * @param filaACambiar - 1-Facturacion, 2-Apartado
	 */
	public RebajasApartado(int filaACambiar) {
		...
		try {
			modeloTablaRebaja.llenarTablaDetalleApartado(productoABuscar, false);
		} catch (ExcepcionCr e) {
			logger.error("RebajasApartado(int)", e);
	...
	private void aplicarDescuento(int renglon, String descuento, String cantidad, boolean esPorcentaje){
		if (logger.isDebugEnabled()) {
			logger
					.debug("aplicarDescuento(int, String, String, boolean) - start");
		}
		...
		try {
			...
			CR.meServ.aplicarDesctoPorDefecto(new Integer(CR.meServ.getApartado().obtenerRenglones(productoABuscar, false).elementAt(renglon).toString()).intValue(), descuentoAAplicar, cant, esPorcentaje);
		
			dispose();
			try {
				finalize();
			} catch (Throwable e1) {
				logger.error("aplicarDescuento(int, String, String, boolean)",
						e1);
			}
		} catch (NumberFormatException e) {
			logger.error("aplicarDescuento(int, String, String, boolean)", e);
		...
		if (logger.isDebugEnabled()) {
			logger
					.debug("aplicarDescuento(int, String, String, boolean) - end");
		}
	}
				...
				if(e.getSource().equals(this.getJButton1())){
					...
					if(jTable.getSelectedRow() == -1){
						...
						if(this.getJRadioButton().isSelected()){ //Aplicar porcentaje como descuento
							...
							this.aplicarDescuento(filaSeleccionada, CR.me.formatoNumerico(getJTextField2().getText()), CR.me.formatoNumerico(getJTextField1().getText()), true);
						} else if(this.getJRadioButton1().isSelected()) { //Aplicar Cambio de Precio
							filaSeleccionada = jTable.getSelectedRow();
							this.aplicarDescuento(filaSeleccionada, CR.me.formatoNumerico(getJTextField2().getText()), CR.me.formatoNumerico(getJTextField1().getText()), false);
						}
					}
				}
					...
					try {
						...
						modeloTablaRebaja.llenarTablaDetalleApartado(productoABuscar, true);
						if(modeloTablaRebaja.getRowCount() > 0){
						...
						modeloTablaRebaja.iniciarDatosTabla(modeloTablaRebaja.getColumnCount());
	...
	private javax.swing.JPanel getJPanel() {
		...
		if(jPanel == null) {
			...
			jPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Identificador", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, null));
	...
	private javax.swing.JPanel getJPanel4() {
		...
		if(jPanel4 == null) {
			...
			jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Detalle del Servicio", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", java.awt.Font.BOLD, 12), java.awt.Color.black));
		}
	...
	private javax.swing.JTable getJTable() {
		...
		if(jTable == null) {
			jTable = new javax.swing.JTable(modeloTablaRebaja);
	...
	private javax.swing.JPanel getJPanel7() {
		...
		if(jPanel7 == null) {
			...
			jPanel7.setLayout(layFlowLayout14);
			...
			jPanel7.add(getJRadioButton(), null);
			jPanel7.add(getJRadioButton1(), null);
			jPanel7.setPreferredSize(new java.awt.Dimension(295,85));
			jPanel7.setBackground(new java.awt.Color(242,242,238));
			jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tipo de Cambio", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", java.awt.Font.BOLD, 12), java.awt.Color.black));
		}
	...
	private javax.swing.JPanel getJPanel9() {
		...
		if(jPanel9 == null) {
			...
			layFlowLayout21.setHgap(15);
			jPanel9.setLayout(layFlowLayout21);
	...
	private javax.swing.JPanel getJPanel10() {
		...
		if(jPanel10 == null) {
			...
			jPanel10.add(getJTextField2(), null);
