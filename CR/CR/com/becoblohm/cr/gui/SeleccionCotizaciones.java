 ...
 * Programa   : SeleccionCotizaciones.java
 * Creado por : Gabriel Martinelli <gmartinelli@beco.com.ve>
 * Creado en  : Aug 11, 2004 - 09:47 AM
 *
 * (c) Becoblohm, C.A.
 * -----------------------------------------------------------------------------
 * 				Actualizaciones
 ...
 */
public class SeleccionCotizaciones extends JDialog implements ComponentListener, KeyListener, MouseListener, ActionListener {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger
			.getLogger(SeleccionCotizaciones.class);
	...
	private ModeloTablaCotizacion cotizacionesObtenidas;
	
	private javax.swing.JLabel jLabel = null;
	private int filaSeleccionada = -1;
	private Vector<Cotizacion> cotizacionesObt;
	/**
	...
	* Fecha: agosto 2011
	*/
	public SeleccionCotizaciones(String identificador, Vector<Cotizacion> cotizaciones) {
		super(MensajesVentanas.ventanaActiva);
		cotizacionesObtenidas = new ModeloTablaCotizacion(cotizaciones);
		initialize();
		this.getJLabel().setText(identificador);
		this.getJTable().setRowSelectionInterval(0,0);
		this.cotizacionesObt = cotizaciones;
	}
	/**
	...
	private javax.swing.JPanel getJPanel() {
		...
		if(jPanel == null) {
			...
			jPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(java.awt.Color.gray,1), "Identificador de Cotización: ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", java.awt.Font.BOLD, 12), java.awt.Color.darkGray));
	...
	private javax.swing.JTable getJTable() {
		...
		if(jTable == null) {
			jTable = new javax.swing.JTable(cotizacionesObtenidas);
	...
	private javax.swing.JLabel getJLabel11() {
		...
		if(jLabel11 == null) {
			...
			jLabel11.setText("Recuperar Cotización ");
	...
	public int obtenerTiendaSeleccionada() {
		...
		int returnint = ((Cotizacion) cotizacionesObt
				.elementAt(filaSeleccionada)).getCodTienda();
		if (logger.isDebugEnabled()) {
	...
	public int obtenerNumServSeleccionado() {
		...
		int returnint = ((Cotizacion) cotizacionesObt
				.elementAt(filaSeleccionada)).getNumServicio();
		if (logger.isDebugEnabled()) {
	...
	public Date obtenerFechaSeleccionada() {
		...
		Date returnDate = ((Cotizacion) cotizacionesObt
				.elementAt(filaSeleccionada)).getFechaServicio();
		if (logger.isDebugEnabled()) {
