 ...
 */
public class SeleccionDevoluciones extends JDialog implements ComponentListener, KeyListener, MouseListener, ActionListener {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger
			.getLogger(SeleccionDevoluciones.class);
	...
	private ModeloTablaDevoluciones devolucionesObtenidas;
	
	private int filaSeleccionada = -1;
	private Vector<String> devolucionesEnEspera;
	private Vector<String> apartadosObt;
	...
	* Fecha: agosto 2011
	*/
	public SeleccionDevoluciones(Vector<String> devoluciones) {
		super(MensajesVentanas.ventanaActiva);
		devolucionesEnEspera = devoluciones;
		devolucionesObtenidas = new ModeloTablaDevoluciones(devoluciones);
		initialize();
		//this.getJLabel().setText(identificador);
		this.getJTable().setRowSelectionInterval(0,0);
		this.apartadosObt = devoluciones;
	}
	/**
	...
	private javax.swing.JTable getJTable() {
		...
		if(jTable == null) {
			jTable = new javax.swing.JTable(devolucionesObtenidas);
	...
	private javax.swing.JScrollPane getJScrollPane() {
		...
		if(jScrollPane == null) {
			...
			jScrollPane.setPreferredSize(new java.awt.Dimension(585,225));
		}
	...
	private javax.swing.JLabel getJLabel11() {
		...
		if(jLabel11 == null) {
			...
			jLabel11.setText("Recuperar Devoluciones en Espera");
	...
	public int obtenerTiendaSeleccionada() {
		...
		//El vector de devoluciones es un arreglo que tiene CI, Nombre, TiendaOrigen, FechaOrigen, No.Caja, TransaccionOrigen
		int returnint = Integer.parseInt((String)devolucionesEnEspera.elementAt(((filaSeleccionada + 1)*6)-4));
		if (logger.isDebugEnabled()) {
	 ...
	 * int
	 */
	public String obtenerFechaOriginal() {
		if (logger.isDebugEnabled()) {
			logger.debug("obtenerNumServSeleccionado() - start");
		}

		String returnString = ((String)devolucionesEnEspera.elementAt(((filaSeleccionada + 1)*6)-3));
		if (logger.isDebugEnabled()) {
	 ...
	 * Date
	 */
	public String obtenerCajaOriginal() {
		if (logger.isDebugEnabled()) {
			logger.debug("obtenerFechaSeleccionada() - start");
		}

		String returnString = ((String)devolucionesEnEspera.elementAt(((filaSeleccionada + 1)*6)-2));
		if (logger.isDebugEnabled()) {
	...
	public int obtenerNumeroTransaccion() {
		...
		int returnint = Integer.parseInt((String)devolucionesEnEspera.elementAt(((filaSeleccionada + 1)*6)-1));
		if (logger.isDebugEnabled()) {
			logger.debug("obtenerTiendaSeleccionada() - end");
		}
		return returnint;
