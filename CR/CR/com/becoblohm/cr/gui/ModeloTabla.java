...
public class ModeloTabla extends AbstractTableModel implements Serializable
{
	 ...
	 */
	private static final Logger logger = Logger.getLogger(ModeloTabla.class);
	...
	{
		super();
		this.mostrarTipoEntrega = true;
		if (Sesion.isUtilizarVendedor()) {
			titulos = new String[]{"Cod. Articulo", "Descripcion", "Cantidad", "P.Regular", "P.Final", "Monto", "Cvta", "Entrega", "Vendedor"};
			Object[][] datos1 = {{"","",new Float(0),new Double(0),new Double(0),new Double(0),"","",""}};
			datos = datos1;
			types = new Class[]{String.class, String.class, Number.class, Number.class, Number.class, Number.class, String.class, String.class, String.class};
		} else {
	...
	public ModeloTabla(boolean mostrarTEntrega)
	{
		super();
		this.mostrarTipoEntrega = mostrarTEntrega;
		
		if (Sesion.isUtilizarVendedor()) {
			if (mostrarTipoEntrega) {
				titulos = new String[]{"Cod. Articulo","Descripcion","Cantidad","P.Regular","P.Final", "Monto", "Cvta","Entrega","Vendedor"};
				Object[][] datos1 = {{"","",new Float(0),new Double(0),new Double(0),new Double(0),"","",""}};
				datos = datos1;
				types = new Class[]{String.class, String.class, Number.class, Number.class, Number.class, Number.class, String.class, String.class};
			} else {
				titulos = new String[]{"Cod. Articulo","Descripcion","Cantidad","P.Regular","P.Final", "Monto", "Cvta","Vendedor"};
				Object[][] datos1 = {{"","",new Float(0),new Double(0),new Double(0),new Double(0),"",""}};
				datos = datos1;
	...
	public void llenarTabla()
	{
		...
		try{
			...
			datos = new Object[CR.meVenta.getVenta().getDetallesTransaccion().size()][titulos.length];
			for(int i=0; i<CR.meVenta.getVenta().getDetallesTransaccion().size(); i++)
			{
				String codProd = ((DetalleTransaccion)CR.meVenta.getVenta().getDetallesTransaccion().elementAt(i)).getProducto().getCodProducto().toString();
				...
				datos[i][0]=codProd;
				datos[i][1]=((DetalleTransaccion)CR.meVenta.getVenta().getDetallesTransaccion().elementAt(i)).getProducto().getDescripcionCorta();
				datos[i][2]=df.format(new Float(((DetalleTransaccion)CR.meVenta.getVenta().getDetallesTransaccion().elementAt(i)).getCantidad()));
				datos[i][3]=df.format(new Double(((DetalleTransaccion)CR.meVenta.getVenta().getDetallesTransaccion().elementAt(i)).getProducto().getPrecioRegular()));
				datos[i][4]=df.format(new Double(((DetalleTransaccion)CR.meVenta.getVenta().getDetallesTransaccion().elementAt(i)).getPrecioFinal()));
				datos[i][5]=df.format(new Double(((DetalleTransaccion) CR.meVenta.getVenta().getDetallesTransaccion().elementAt(i)).getCantidad() * ((DetalleTransaccion) CR.meVenta.getVenta().getDetallesTransaccion().elementAt(i)).getPrecioFinal()));
				datos[i][6]=((DetalleTransaccion)CR.meVenta.getVenta().getDetallesTransaccion().elementAt(i)).getCondicionVenta();
				datos[i][7]=((DetalleTransaccion)CR.meVenta.getVenta().getDetallesTransaccion().elementAt(i)).getTipoEntrega();
				if (Sesion.isUtilizarVendedor()) {
					datos[i][8]=((DetalleTransaccion)CR.meVenta.getVenta().getDetallesTransaccion().elementAt(i)).getCodVendedor();
				}
			}
			fireTableDataChanged();
	 ...
	 * 
	 */
	public void llenarTabla(String codProducto, boolean isCodigoExterno) throws ProductoExcepcion, MaquinaDeEstadoExcepcion, XmlExcepcion, FuncionExcepcion, BaseDeDatosExcepcion, ConexionExcepcion 
	{
		if (logger.isDebugEnabled()) {
		...
		try{
			...
			Vector<Integer> renglones = CR.meVenta.obtenerRenglones(codProducto, isCodigoExterno);
