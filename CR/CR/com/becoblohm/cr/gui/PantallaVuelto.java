 ...
 */
public class PantallaVuelto extends JDialog implements ComponentListener, KeyListener, MouseListener {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(PantallaVuelto.class);
	...
	private String vuelto = null;
	
	private javax.swing.JLabel jLabel2 = null;
	/**
	 * This is the default constructor
	 */
	public PantallaVuelto(double mtoVuelto, boolean aperturarGaveta) {
		...
		/*if((CR.meVenta.getVenta().getMontoVuelto())*100 < 1)
			vuelto = df.format(0);
		else
			vuelto = df.format(CR.meVenta.getVenta().getMontoVuelto());*/
		
		//getJLabel().setText(Sesion.getTienda().getMonedaBase() + " " + vuelto);
		vuelto = df.format(mtoVuelto);
		getJLabel().setText(Sesion.getTienda().getMonedaBase() + " " + vuelto);
		getJLabel2().setText("Bs. " + df.format(mtoVuelto*1000));
		
		//********
		//Se verifica si la gaveta se abre por impresora o por el visor. Si es por impresora NO debemos abrir
		//porque ya enviamos a abrir en las clases de reporte antes de enviar a imprimir por problema de espera
		...
		if (aperturarGaveta) {
			if (!Sesion.aperturaGavetaPorImpresora) {
				try {
					...
					logger.error("PantallaVuelto(String)", e);
				}
			 }
		}
		//********
	...
	public void keyPressed(KeyEvent e) {
		...
		if((e.getKeyCode() == KeyEvent.VK_ENTER) || (e.getKeyCode() == KeyEvent.VK_ESCAPE) || (e.getKeyCode() == KeyEvent.VK_SPACE)){
			...
			/**
			 * Limpia el vector donacionesRegistradas en cada transaccion
			 * 
			 */
	...
	private javax.swing.JButton getJButton1() {
		...
		if(jButton1 == null) {
			jButton1 = new JHighlightButton(new java.awt.Color(226,226,222));
	...
	private javax.swing.JPanel getJPanel3() {
		...
		if(jPanel3 == null) {
			...
			jPanel3.setPreferredSize(new java.awt.Dimension(330,112));
	...
	private javax.swing.JPanel getJPanel4() {
		...
		if(jPanel4 == null) {
			...
			jPanel4.setPreferredSize(new java.awt.Dimension(330,40));
	...
	private javax.swing.JLabel getJLabel1() {
		...
		if(jLabel1 == null) {
			...
			jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/becoblohm/cr/gui/resources/icons/ix32x32/money.png")));
		}
	...
	private javax.swing.JPanel getJPanel1() {
		...
		if(jPanel1 == null) {
			...
			jPanel1.setPreferredSize(new java.awt.Dimension(315,53));
	...
	private javax.swing.JPanel getJPanel5() {
		...
		if(jPanel5 == null) {
			...
			jPanel5.setPreferredSize(new java.awt.Dimension(315,60));
