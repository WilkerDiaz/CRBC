...
public class PantallaDetallesCambiados extends JDialog implements ComponentListener,  KeyListener, MouseListener {
	/**
	...
	private ModeloTablaDetallesCambiados modeloTablaDetallesCambiados = new ModeloTablaDetallesCambiados();
	protected Vector<Vector<Object>> detallesCambiados;
	 ...
	 */
	public PantallaDetallesCambiados(Vector<Vector<Object>> detalles) {
		...
		this.detallesCambiados = detalles;
	...
	protected void initialize() {
		...
		this.setSize(665, 333);
		this.setContentPane(getJContentPane());
		this.setUndecorated(true);
		this.setModal(true);
		this.setBackground(new java.awt.Color(226,226,222));
		this.setTitle("Detalles afectados por promociones especiales");
	...
	private javax.swing.JPanel getJPanel2() {
		...
		if(jPanel2 == null) {
			...
			jPanel2.setPreferredSize(new java.awt.Dimension(640,35));
	...
	private javax.swing.JPanel getJPanel3() {
		...
		if(jPanel3 == null) {
			...
			jPanel3.setPreferredSize(new java.awt.Dimension(640,245));
	...
	private javax.swing.JPanel getJPanel4() {
		...
		if(jPanel4 == null) {
			...
			jPanel4.setPreferredSize(new java.awt.Dimension(635,50));
	...
	private javax.swing.JLabel getJLabel1() {
		...
		if(jLabel1 == null) {
			...
			jLabel1.setText("Detalles afectados por promociones especiales");
	...
	private javax.swing.JPanel getJPanel5() {
		...
		if(jPanel5 == null) {
			...
			jLabelMensaje.setFont(new Font("Dialog", Font.ITALIC, 12));
			
			jLabelMensaje.setText("Los descuentos iguales al 100% del costo de un artículo se reflejarán como forma de pago.");
			...
			jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, " Detalles: ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", java.awt.Font.BOLD, 12), java.awt.Color.black));
			jPanel5.setBackground(new java.awt.Color(242,242,238));
			jPanel5.add(jLabelMensaje, null);
		}
	...
	private javax.swing.JScrollPane getJScrollPane() {
		...
		if(jScrollPane == null) {
			...
			jScrollPane.setPreferredSize(new java.awt.Dimension(605,115));
	...
	private javax.swing.JTable getJTable() {
		...
		if(jTable == null) {
			jTable = new javax.swing.JTable(modeloTablaDetallesCambiados);
	...
	private void repintarPantalla(){
		...
		try{
			modeloTablaDetallesCambiados.llenarTabla(this.detallesCambiados);
			this.getJTable().setRowSelectionInterval(0,0);
		} catch (Exception ex){
			logger.error("repintarPantalla()", ex);
			modeloTablaDetallesCambiados.iniciarDatosTabla(this.getJTable().getColumnCount());
		}
