/*
 * $Id: MySQLReplaceScriptDataFile.java,v 1.2 2005/03/30 17:50:04 programa4 Exp $
 * ===========================================================================
 ...
 * Actualizaciones:
 * ---------------------------------------------------------------------------
 * $Log: MySQLReplaceScriptDataFile.java,v $
 ...
 * @since 27/12/2004 @
 */
public class MySQLReplaceScriptDataFile extends MySQLScriptDataFile {
    /**
     * @since 27/12/2004
     * @param outputfile
     * @param versionMySQL
     * @throws IOException
     */
    public MySQLReplaceScriptDataFile(File outputfile, String versionMySQL)
            throws IOException {
     ...
     * @throws IOException
     */
    public MySQLReplaceScriptDataFile(String outputfile, String versionMySQL)
            throws IOException {
        super(outputfile, versionMySQL);
    }
