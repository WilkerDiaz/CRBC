/*
 * $Id: MySQLInsertIgnoreScriptDataFile.java,v 1.2 2005/03/30 17:50:03 programa4 Exp $
 * ===========================================================================
 ...
 * Actualizaciones:
 * ---------------------------------------------------------------------------
 * $Log: MySQLInsertIgnoreScriptDataFile.java,v $
 ...
 * @since 27/12/2004 @
 */
public class MySQLInsertIgnoreScriptDataFile extends MySQLScriptDataFile {
    /**
     * @since 27/12/2004
     * @param outputfile
     * @param versionMySQL
     * @throws IOException
     */
    public MySQLInsertIgnoreScriptDataFile(File outputfile, String versionMySQL)
            throws IOException {
     ...
     * @throws IOException
     */
    public MySQLInsertIgnoreScriptDataFile(String outputfile, String versionMySQL)
            throws IOException {
        super(outputfile, versionMySQL);
    }
	...
	*/
    public String getSQL(String nombreTabla, Map<String,Object>[] datos) {
        ...
        if (datos.length > 0) {
            ...
            sqlInsert.append("INSERT IGNORE INTO ");
